...
//         analyzeImage(selectedImage.src, elementInput)
//         .then(tagFound => {
//             if (tagFound) {
//                 console.log(`The tag "${tagToFind}" was found in the image.`);
//             } else {
//                 console.log(`The tag "${tagToFind}" was not found in the image.`);
//             }
//         })
//         .catch(error => {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    analysebutton.addEventListener('click',() => {
        ...
        .then(tagFound => {
            if (tagFound) {
                resultLabel.textContent = `The tag "${tagToFind}" was found in the image.`;
            } else {
                resultLabel.textContent = `The tag "${tagToFind}" was not found in the image.`;
            }
        })
        .catch(error => {
            resultLabel.textContent = `Error analyzing image: ${error.message}`;
        });
    });
